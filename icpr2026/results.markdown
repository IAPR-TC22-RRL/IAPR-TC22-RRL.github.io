---
title: RRPR badge results
permalink: /icpr2026/results/
---
...
# Results of the 1st ICPR 2026 Reproducibility Badge in Pattern Recognition
This is the list of papers that have been granted with the 1st **ICPR 2026 Reproducibility Badge in Pattern Recognition** in each of the six categories.

Please note that the reasons why a particular submission is not be listed here are diverse. First, it's unrelated with the scientific quality of the work, as a paper can be accepted in ICPR and yet not be granted the badge despite its scientific interest. Here we evaluated only its numerical reproducibility.
A paper which didn't get to the list could actually be reproducible and the reasons for not being finally badge might be simply that the authors didn't have the time to include before the deadline a proper software license or any important details that were requested.

For the papers that were granted with the badge, they were first checked by random reviewers (preferably in the corresponding area), and checked again by the meta-reviewers. The meta-reviewers based their decision on the analysis of the reviewers, and made additional requests when needed. These last requests were typically adding a proper software license or specifying the version of the libraries, in most of the cases.

Congratulations to the authors, who we also thank for their effort towards reliable reproducible and open science!
...
Sejin Sim (Korea University); SeoungBum Kim (Korea University)

**Markovian Reeb Graphs for Simulating Spatiotemporal Patterns of Life**  
Anantajit Subrahmanya (University of California; Santa Barbara); Chandrakanth Gudavalli (University of California; Santa Barbara); Connor Levenson (University of California; Santa Barbara); B.S. Manjunath (University of California; Santa Barbara)

**DrivingWorld: Constructing World Model for Autonomous Driving via Video GPT**  
Xiaotao Hu (Hong Kong University of Science and Technology); Mingkai Jia (Hong Kong University of Science and Technology); Xiaoyang Guo (The Chinese University of Hong Kong); Qian Zhang (Horizon Robotics); Xiaoxiao Long (Nanjing University); Wei Yin (Horizon Robotics)

**Kinetic Mining in Context: Few-Shot Action Synthesis via Text-to-Motion Distillation**  
Luca Cazzola (University of Trento); Ahed Alboody (CESI LINEACT)

**Local Autoregression with Finite-Support Random Variables for Image Generation**  
chenqiu zhao (Multimedia Research Centre; Department of Computing Science; University of Alberta); Anup Basu (Multimedia Research Centre; Department of Computing Science; University of Alberta)

**Unsupervised Learning of Density Estimates with Topological Optimization**  
Sunia Tanweer (Michigan State University); Firas A. Khasawneh (Michigan State University)

**Rotation-free Online Handwritten Character Recognition using Linear Recurrent Units**  
Danyu Yang (College of Mathematics and Statistics; Chongqing University)
...
Al Zadid Sultan Bin Habib (West Virginia University); Tanpia Tasnim (Green University of Bangladesh); Md. Ekramul Islam (Stamford University Bangladesh); Muntasir Tabasum (West Virginia University)

**Few-shot Supervised Contrastive Learning for Image/Video Distortion Classification**  
Riestiya Zain Fadillah (Norwegian University of Science and Technology (NTNU)); Seyed Ali Amirshahi (Norwegian University of Science and Technology (NTNU)); Marius Pedersen (Norwegian University of Science and Technology (NTNU)); Azeddine Beghdadi (Université Sorbonne Paris Nord)

**Visibility-Aware Diffusion-Based Face Anonymization for Real-World Deployment**  
Mohamed Jaouad LAHGAZI (Gustave Eiffel University); Jean-Philippe Tarel (Gustave Eiffel University)

**Inherently Interpretable Graph Neural Networks via B-cos Alignment**  
Shruti Pandey (NISER); Subhankar Mishra (NISER)

**Aggregation of ensemble of classifiers with fuzzy learning: Application for land cover classification on SAR images**  
Matthieu Gallet (LISTIC USMB); Abdourrahmane Atto (LISTIC USMB); Fatima Karbou (CEN CNRM); Emmanuel Trouvé (LISTIC USMB)

**EOPD-SR:Entity-Ontology and Path-Dependency Subgraph Retrieval for Knowledge Graph–Augmented Reasoning**  
Jiawen Xue (College of Computer Science and Software Engineering; Hohai University); Yu Tang (College of Computer Science and Software Engineering; Hohai University); Yingchi Mao (College of Computer Science and Software Engineering; Hohai University); Zicheng Wang (China Power Construction Group Kunming Survey Design&research Institute Co.;Ltd.); Zhenxiang Pan (College of Computer Science and Software Engineering; Hohai University); Bingbing Nie (Huaneng Lancang River Hydropower Inc.); Rongzhi Qi (College of Computer Science and Software Engineering; Hohai University)
...
Mohamed BenHabirech (University of Kasdi Merbah Ouargla); Mourad Belhadj (University of Kasdi Merbah Ouargla; Ouargla; Algeria); Dalila Tamzalit (Nantes University; Nantes; France); Oussama Aiadi (University of Kasdi Merbah Ouargla; Ouargla; Algeria)

**From Gameplay Traces to Game Mechanics: Causal Induction with Large Language Models**  
Mohit Jiwatode (Leibniz University Hannover); Alexander Dockhorn (University of Southern Denmark); Bodo Rosenhahn (Leibniz University Hannover)
...
Yuxin Xiao (Beijing University of Chemical Technology); Riad Valiyev (Beijing University of Chemical Technology); Xukun Zhu (Shandong University of Science and Technology); Quanlin Meng (Beijing University of Chemical Technology); Ruirui Li (Beijing University of Chemical Technology)
...
Ishmam Tashdeed (Islamic University of Technology); Md. Atiqur Rahman (Islamic University of Technology); Sabrina Islam (Islamic University of Technology); Md. Azam Hossain (Islamic University of Technology)
...
Dhammadip Kamble (Indian Institute of Technology Bhilai); Sushrut Patwardhan (Norwegian University of Science and Technology); Anil Sao (Indian Institute of Technology Bhilai); Arvind Sharma (Norwegian University of Science and Technology); Raghavendra Ramachandra (Norwegian University of Science and Technology)

**Embedding Arithmetic: A Lightweight; Tuning-Free Framework for Post-hoc Bias Mitigation in Text-to-Image Models**  
Venkatesh Thirugnana Sambandham (Ingolstadt University of Applied Sciences); Torsten Schön (Ingolstadt University of Applied Sciences)
...
Stefano Berti (IIT); Giulia Paquale (IIT); Lorenzo Natale (IIT)

**How to Evaluate and Refine your CAM**  
Luca Domeniconi (Universitá di Bologna); Alessandra Stramiglio (Universitá di Bologna); Michele Lombardi (Universitá di Bologna); Samuele Salti (Universitá di Bologna)
...
Alexander Tarvo (University of Washington); Xu Chen (University of Washington); Colin Acton (University of Washington); Yusen Wan (University of Washington)

**Paired Uniform Cubic B-Splines are Strong Approximation to Represent Skeleton Activity**  
Muhammad Amirul Raziq Rosman (Universiti Brunei Darussalam); Owais Ahmed Malik (Atlantic Technological University); Daphne Teck Ching Lai (Universiti Brunei Darussalam); Wee Hong Ong (Universiti Brunei Darussalam)

**Yoga-MAtNODE: Multi-View Attention Neural ODE for Skeleton-Based Yoga Pose Recognition**  
Rashi Niyas P (ndian Institute of Technology Madras Zanzibar); Hitika Tiwari (Indian Institute of Technology Madras Zanzibar); Tushar Shinde (Indian Institute of Technology Madras Zanzibar)

**Feature-level Interaction Explanations in Multimodal Transformers**  
Yeji Kim (University of Alberta); Housam Babiker (University of Alberta); Mi-Young Kim (University of Alberta); Randy Goebel (University of Alberta)

**Break Out the Silverware: Semantic Understanding of Stored Household Items**  
Michaela Levi Richter (Bar-Ilan University); Reuth Mirsky (Tufts University); Oren Glickman (Bar-Ilan University)
...
Pius Horn (Institute for Machine Learning and Analytics (IMLA); Offenburg University); Janis Keuper (Institute for Machine Learning and Analytics (IMLA); Offenburg University)

**Modern Summarization Methods for Diplomatic Documents: Current State and Limitations**  
Merlin Streilein (UniBe); Tobias Steiner (UniBe); Kaspar Riesen (UniBe); Andreas Fischer (UniFr)

**Hybrid classical-quantum architecture for vectorised image classification of hand-written sketches**  
Yeray Cordero Carrasco (Computer Vision Center); Sanket Biswas (Computer Vision Center); Fernando Vilariño (Computer Vision Center); Matias Bilkis (Computer Vision Center)

**Decoding-Time Fusion of OCR and Large Language Models for Traditional Chinese Historical Document Recognition**  
Zih-Ci Lin (National Chengchi University); Wen-Hung Liao (National Chengchi University)

**The Pragmatic Persona: Discovering LLM Persona through Bridging Inference**  
Jongwon Ryu (Chung-Ang University); Jisoo Yang (Chung-Ang University); Minuk Ma (University of British Columbia); Trung X. Pham (Korea Advanced Institute of Science and Technology); Junyeong Kim (Chung-Ang University)
...
Wonder Luz Alves (Universidade Nove de Julho); Lucas Santos (Universidade Nove de Julho); Ronaldo Hashimoto (Universidade de São Paulo); Nicolas Passat (Université de Reims Champagne Ardenne); Anderson Souza (Universidade Nove de Julho); Dennis Silva (Université de Reims Champagne Ardenne); Yukiko Kenmochi (Normandie Université)
