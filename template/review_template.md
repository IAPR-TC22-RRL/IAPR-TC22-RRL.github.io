...
## Configuration used by the reviewer
...
* There is a **README file** with instructions on how to compile and run the code :
  ...
  * [ ] No
* The **data** needed to reproduce the results are publicly available:
  * [ ] Yes, all
  * [ ] Yes, for the most part
  * [ ] Not yet, but they will be if the label is awarded
  * [ ] No, there is essential data missing that cannot be made public
* The **elements to be reproduced** are available:
  * [ ] Yes, all
  * [ ] Yes, for the most part
  * [ ] No, essential data was missing
